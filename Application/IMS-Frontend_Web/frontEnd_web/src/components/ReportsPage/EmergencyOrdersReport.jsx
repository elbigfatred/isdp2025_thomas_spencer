...
const EmergencyOrdersReport = () => {
  ...
  const handleDownload = () => {
    ...
    link.download = `emergency_orders_report.${fileExtension}`;
  ...
  return (
    <Box>
      <Typography variant="h6" gutterBottom>
        Emergency Orders Report Options
      </Typography>
...
export default EmergencyOrdersReport;
